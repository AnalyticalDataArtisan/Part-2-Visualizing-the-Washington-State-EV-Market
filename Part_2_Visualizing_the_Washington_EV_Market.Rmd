---
title: "Part 2: Visualizing the Washington EV Market"
output:
...
ggplot(market_df, aes(x = "", y = market_share, fill = Group)) +
  ...
  labs(title = "Tesla Market Share in Washington State",
...
ggplot(make_model_sold, aes(x = reorder(Model, -count_sold), y = count_sold)) +
  ...
  labs(title = "Top Selling Tesla Models in Washington State",
       x = "Model",
       y = "Vehicles Sold",
       caption = "Last update: April 2025") +
  theme_minimal() +
...
ggplot(tesla_sold_by_year, aes(x = Model_Year, y = Count)) +
  ...
  labs(title = "Tesla Vehicles Sold by Year in Washington State",
       x = "Year",
       y = "Count",
       caption = "Last update: April 2025") +
  theme_minimal() +
...
ggplot(phev_vs_bev, aes(x = Model_Year, y = Count, color = Electric_Vehicle_Type)) +
  ...
  scale_color_manual(values = c(
    "Battery Electric Vehicle (BEV)" = "steelblue",
    "Plug-in Hybrid Electric Vehicle (PHEV)" = "gray60"
  )) +
  ...
  theme(
    legend.position = "bottom",
    plot.margin = margin(t = 10, r = 30, b = 30, l = 10),  # increase bottom margin
    plot.title = element_text(hjust = 0.5),
    plot.caption = element_text(hjust = 1, size = 8, face = "italic"),  # right-align caption
)
...
ggplot(top_5_utility_count_for_teslas, aes(x = reorder(Electric_Utility, Count), y = Count)) +
  geom_col(fill = "steelblue") +
  coord_flip() +
  labs(title = "Top 5 Tesla Utilities in Washington State",
       x = "Utility",
       y = "Tesla Count",
       caption = "Last update: April 2025") +
  theme_minimal() +
